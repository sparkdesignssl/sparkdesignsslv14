...
function initThree() {
  ...
  function layoutPyramids() {
    ...
    camera.position.z = mob ? 7.5 : 5;
    leftGroup.position.x = mob ? -1.4 : -2.8;
    rightGroup.position.x = mob ? 1.4 : 2.8;
    leftGroup.scale.setScalar(mob?0.62:1);
    rightGroup.scale.setScalar(mob?0.62:1);
  }
  layoutPyramids();
