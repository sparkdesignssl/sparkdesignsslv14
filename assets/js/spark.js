...
function initThree() {
  ...
  const mats = [
    new THREE.MeshStandardMaterial({color:0x030303, roughness:0.18, metalness:0.82, emissive:0x220000, emissiveIntensity:0.08}),
    new THREE.MeshStandardMaterial({color:0x160000, roughness:0.16, metalness:0.88, emissive:0x660000, emissiveIntensity:0.22}),
    new THREE.MeshStandardMaterial({color:0x080000, roughness:0.22, metalness:0.75, emissive:0x440000, emissiveIntensity:0.14}),
  ];
  ...
  function spawnAsteroid(scatterInit) {
    ...
    const speed = rnd(0.018, 0.045) / size;
    const angle = rnd(0, Math.PI * 2);
    mesh.userData = {
      vx: Math.cos(angle) * speed,
      vy: Math.sin(angle) * speed,
      rx: rnd(0.002, 0.008) * (Math.random() < 0.5 ? 1 : -1),
      ry: rnd(0.003, 0.010) * (Math.random() < 0.5 ? 1 : -1),
      rz: rnd(0.001, 0.006) * (Math.random() < 0.5 ? 1 : -1),
      size,
    };
